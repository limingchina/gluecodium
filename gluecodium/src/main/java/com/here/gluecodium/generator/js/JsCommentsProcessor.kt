...
/**
 * Parse Markdown comments and process links for the JS generator. Produces JSDoc/TSDoc-compatible
 * comment text (emitted inside block comments in `.d.ts` stubs).
 */
class JsCommentsProcessor(werror: Boolean) :
    ...
    override val nullReference = "undefined"
}
