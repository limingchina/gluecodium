 ...
 * Struct-backed exceptions still need their payload headers, including headers reached through
 * type aliases. The required `Return.h` is already pulled in via `_return_caster.h`.
 */
