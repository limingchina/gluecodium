 ...
 * The Python exception class is generated by `PythonException.mustache` and registered via
 * `Pybind11Exception.mustache`, which only needs the common pybind11 headers.
 */
