...
class OuterInterface(generated.smoke_OuterInterface):
    ...
    class InnerInterface(generated.smoke_OuterInterface.InnerInterface):
        def __init__(self, native=None):
            # Subclass the native pybind11 type so that a Python override of an interface
            # method is dispatched through the generated trampoline. When `native` is an
            # existing native instance (returned by a factory), adopt it via the generated
            ...
            # native object uniformly (e.g. when passing this interface back into a C++
            # call site).
            if native is not None and isinstance(native, generated.smoke_OuterInterface.InnerInterface):
                super().__init__(native)
            else:
                super().__init__()
            self._native = self
        ...
        def foo(self, input: str) -> str:
            return _wrap(generated.smoke_OuterInterface.InnerInterface.foo(self, _unwrap(input, str)), str)
