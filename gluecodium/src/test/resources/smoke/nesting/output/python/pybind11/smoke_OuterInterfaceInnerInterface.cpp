...
class OuterInterfaceInnerInterfaceTrampoline : public InnerInterface {
public:
...
void register_smoke_OuterInterfaceInnerInterface(py::module_& module) {
    py::class_<InnerInterface, std::shared_ptr<InnerInterface>, OuterInterfaceInnerInterfaceTrampoline>(module, "smoke_OuterInterfaceInnerInterface")
        .def(py::init<>())
        ...
        .def(py::init([](std::shared_ptr<InnerInterface> native) {
            auto self = std::make_shared<OuterInterfaceInnerInterfaceTrampoline>();
            self->m_impl = native;
            return self;
        }))
