...
class OuterClassWithInheritance(generated.smoke_OuterClassWithInheritance):
    ...
    class InnerInterface(generated.smoke_OuterClassWithInheritanceInnerInterface):
        def __init__(self, native=None):
        ...
        def baz(self, input: str) -> str:
            return _wrap(generated.smoke_OuterClassWithInheritanceInnerInterface.baz(self, _unwrap(input, str)), str)
