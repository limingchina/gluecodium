...
class SerializableStructWithExternalField(_NativeBase):
    ...
    def __init__(self, *args):
        if len(args) == 1 and isinstance(args[0], generated.kotlin_smoke_SerializableStructWithExternalField):
            super().__init__(args[0])
        else:
            super().__init__(generated.kotlin_smoke_SerializableStructWithExternalField(*[_unwrap(arg) for arg in args]))
