...
using ExternalMarkedAsSerializable = ::dontsmoke::ExternalMarkedAsSerializable;

void register_dontsmoke_ExternalMarkedAsSerializable(py::module_& module) {
    py::class_<ExternalMarkedAsSerializable>(module, "dontsmoke_ExternalMarkedAsSerializable")
