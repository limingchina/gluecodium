...
class SkipFunctions(_NativeBase):
    ...
    def not_in_java(input: str) -> str:
        """"""
        native_result = generated.SkipFunctions.not_in_java(input)
    ...
    def not_in_swift(input: bool) -> bool:
        """"""
        native_result = generated.SkipFunctions.not_in_swift(input)
    ...
    def not_in_dart(input: float) -> float:
        """"""
        native_result = generated.SkipFunctions.not_in_dart(input)
    ...
    def not_in_kotlin(input: str) -> str:
        """"""
        native_result = generated.SkipFunctions.not_in_kotlin(input)
        return str(native_result)
