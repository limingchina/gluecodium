...
public:
    ...
    std::shared_ptr<SkipTagsInJava> m_impl;
...
void register_smoke_SkipTagsInJava(py::module_& module) {
    py::class_<SkipTagsInJava, std::shared_ptr<SkipTagsInJava>, SkipTagsInJavaTrampoline>(module, "smoke_SkipTagsInJava")
        .def(py::init<>())
        ...
        .def(py::init([](std::shared_ptr<SkipTagsInJava> native) {
            auto self = std::make_shared<SkipTagsInJavaTrampoline>();
            self->m_impl = native;
            return self;
        }))
