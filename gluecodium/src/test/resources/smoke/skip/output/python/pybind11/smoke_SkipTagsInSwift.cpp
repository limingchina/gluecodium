...
using SkipTagsInSwift = ::smoke::SkipTagsInSwift;
...
public:
    ...
    std::shared_ptr<SkipTagsInSwift> m_impl;
...
void register_smoke_SkipTagsInSwift(py::module_& module) {
    py::class_<SkipTagsInSwift, std::shared_ptr<SkipTagsInSwift>, SkipTagsInSwiftTrampoline>(module, "SkipTagsInSwift")
        ...
        .def(py::init([](std::shared_ptr<SkipTagsInSwift> native) {
            auto self = std::make_shared<SkipTagsInSwiftTrampoline>();
            self->m_impl = native;
            return self;
        }))
        ;
