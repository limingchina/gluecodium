...
public:
    ...
    std::shared_ptr<EnableTagsInJava> m_impl;
    ...
    void enable_tagged(
        ...
        PYBIND11_OVERRIDE_PURE(void, EnableTagsInJava, enable_tagged);
    }
    void dont_enable_tagged(
        ...
        PYBIND11_OVERRIDE_PURE(void, EnableTagsInJava, dont_enable_tagged);
    }
    void enable_tagged_list(
        ...
        PYBIND11_OVERRIDE_PURE(void, EnableTagsInJava, enable_tagged_list);
    }
};
...
void register_smoke_EnableTagsInJava(py::module_& module) {
    py::class_<EnableTagsInJava, std::shared_ptr<EnableTagsInJava>, EnableTagsInJavaTrampoline>(module, "EnableTagsInJava")
        ...
        .def(py::init([](std::shared_ptr<EnableTagsInJava> native) {
            auto self = std::make_shared<EnableTagsInJavaTrampoline>();
            self->m_impl = native;
            return self;
        }))
        ;
