...
void register_smoke_EnableTagsInKotlin(py::module_& module) {
    py::class_<EnableTagsInKotlin, std::shared_ptr<EnableTagsInKotlin>, EnableTagsInKotlinTrampoline>(module, "smoke_EnableTagsInKotlin")
        .def(py::init<>())
