...
void register_ClassWithStructWithSkipLambdaInPlatformSkipLambdaInPlatform(py::module_& module) {
    py::class_<SkipLambdaInPlatform>(module, "ClassWithStructWithSkipLambdaInPlatformSkipLambdaInPlatform")
        ...
        .def("use_lambda", &SkipLambdaInPlatform::use_lambda, py::arg("some_lambda"))
