...
void register_smoke_SerializationNestedSerializableStruct(py::module_& module) {
    py::class_<NestedSerializableStruct>(module, "smoke_SerializationNestedSerializableStruct")
