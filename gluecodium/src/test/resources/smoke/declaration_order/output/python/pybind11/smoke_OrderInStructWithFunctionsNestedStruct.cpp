...
void register_smoke_OrderInStructWithFunctionsNestedStruct(py::module_& module) {
    py::class_<NestedStruct>(module, "smoke_OrderInStructWithFunctionsNestedStruct")
