...
void register_smoke_DeclarationOrderWithFunctionsThrownStruct(py::module_& module) {
    py::class_<ThrownStruct>(module, "smoke_DeclarationOrderWithFunctionsThrownStruct")
