...
void register_smoke_DeclarationOrderWithFunctionsParameterStruct(py::module_& module) {
    py::class_<ParameterStruct>(module, "smoke_DeclarationOrderWithFunctionsParameterStruct")
