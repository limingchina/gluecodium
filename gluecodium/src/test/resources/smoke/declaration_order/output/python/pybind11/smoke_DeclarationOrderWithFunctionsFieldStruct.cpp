...
void register_smoke_DeclarationOrderWithFunctionsFieldStruct(py::module_& module) {
    py::class_<FieldStruct>(module, "smoke_DeclarationOrderWithFunctionsFieldStruct")
