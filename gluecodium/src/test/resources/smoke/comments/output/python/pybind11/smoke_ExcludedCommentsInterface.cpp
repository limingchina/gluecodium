...
public:
    using ExcludedCommentsInterface::ExcludedCommentsInterface;
    ...
    std::shared_ptr<ExcludedCommentsInterface> m_impl;
...
void register_smoke_ExcludedCommentsInterface(py::module_& module) {
    py::class_<ExcludedCommentsInterface, std::shared_ptr<ExcludedCommentsInterface>, ExcludedCommentsInterfaceTrampoline>(module, "ExcludedCommentsInterface")
        ...
        .def(py::init([](std::shared_ptr<ExcludedCommentsInterface> native) {
            auto self = std::make_shared<ExcludedCommentsInterfaceTrampoline>();
            self->m_impl = native;
            return self;
        }))
        ;
