...
class FieldConstructorsInternalFields(_NativeBase):
    ...
    def __init__(self, *args):
        if len(args) == 1 and isinstance(args[0], generated.FieldConstructorsInternalFields):
            super().__init__(args[0])
        else:
            super().__init__(generated.FieldConstructorsInternalFields(*[getattr(arg, "_native", arg) for arg in args]))
