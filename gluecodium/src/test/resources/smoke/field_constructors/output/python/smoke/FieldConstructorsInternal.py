...
class FieldConstructorsInternal(_NativeBase):
    ...
    def __init__(self, *args):
        if len(args) == 1 and isinstance(args[0], generated.smoke_FieldConstructorsInternal):
            super().__init__(args[0])
        else:
            super().__init__(generated.smoke_FieldConstructorsInternal(*[_unwrap(arg) for arg in args]))
    ...
    def internal_field(self, value: float):
      self._native.internal_field = _unwrap(value, float)
