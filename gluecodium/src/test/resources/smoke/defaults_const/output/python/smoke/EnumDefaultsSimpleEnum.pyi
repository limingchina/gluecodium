...
class EnumDefaultsSimpleEnum(_NativeBase):
    ...
    def __init__(self, *args):
        if len(args) == 1 and isinstance(args[0], generated.smoke_EnumDefaultsSimpleEnum):
            super().__init__(args[0])
        else:
            super().__init__(generated.smoke_EnumDefaultsSimpleEnum(*[_unwrap(arg) for arg in args]))
