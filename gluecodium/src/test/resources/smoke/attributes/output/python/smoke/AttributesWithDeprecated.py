...
class AttributesWithDeprecated(_NativeBase):
    ...
    class SomeStruct(_NativeBase):
        def __init__(self, *args, **kwargs):
            if len(args) == 1 and not kwargs and isinstance(args[0], generated.smoke_AttributesWithDeprecated.SomeStruct):
                super().__init__(args[0])
            else:
                super().__init__(generated.smoke_AttributesWithDeprecated.SomeStruct(
