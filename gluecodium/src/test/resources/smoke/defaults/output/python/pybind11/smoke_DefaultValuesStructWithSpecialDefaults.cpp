...
void register_DefaultValuesStructWithSpecialDefaults(py::module_& module) {
    py::class_<StructWithSpecialDefaults>(module, "DefaultValuesStructWithSpecialDefaults")
