...
class DefaultValuesStructWithEmptyDefaults(_NativeBase):
    ...
    def __init__(self, *args):
        if len(args) == 1 and isinstance(args[0], generated.DefaultValuesStructWithEmptyDefaults):
            ...
            super().__init__(generated.DefaultValuesStructWithEmptyDefaults(*[getattr(arg, "_native", arg) for arg in args]))
    ...
    def struct_field(self) -> DefaultValuesStructWithDefaults:
        """"""
        return DefaultValuesStructWithDefaults(self._native.struct_field)
    @struct_field.setter
