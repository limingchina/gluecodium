...
void register_TypesWithDefaultsImmutableStructWithFieldConstructorAndNullableFieldUsingImmutableStruct(py::module_& module) {
    py::class_<ImmutableStructWithFieldConstructorAndNullableFieldUsingImmutableStruct>(module, "TypesWithDefaultsImmutableStructWithFieldConstructorAndNullableFieldUsingImmutableStruct")
