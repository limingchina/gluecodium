...
class InternalChildTrampoline : public InternalChild {
public:
    using InternalChild::InternalChild;
    ...
    std::shared_ptr<InternalChild> m_impl;

};

void register_smoke_InternalChild(py::module_& module) {
    py::class_<InternalChild, ::smoke::InternalParent, std::shared_ptr<InternalChild>, InternalChildTrampoline>(module, "smoke_InternalChild")
        .def("__gluecodium_id__", [](const InternalChild& self) {
        ...
        .def(py::init([](std::shared_ptr<InternalChild> native) {
            auto self = std::make_shared<InternalChildTrampoline>();
            self->m_impl = native;
            return self;
        }))
        ;
