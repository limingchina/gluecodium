...
void register_OuterStructWithInternalAttributeClassNestedInInternalStruct(pybind11::module_& module);
...
void register_PublicClassInternalEnum(pybind11::module_& module);
...
PYBIND11_MODULE(generated, m) {
    ...
    register_OuterStructWithInternalAttributeClassNestedInInternalStruct(m);
    register_OuterStructWithInternalAttributeStructNestedInInternalStruct(m);
    register_PublicClass(m);
    register_PublicClassInternalEnum(m);
