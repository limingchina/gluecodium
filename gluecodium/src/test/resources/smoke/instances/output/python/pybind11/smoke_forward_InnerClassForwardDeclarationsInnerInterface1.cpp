...
class InnerClassForwardDeclarationsInnerInterface1Trampoline : public InnerInterface1 {
public:
...
void register_InnerClassForwardDeclarationsInnerInterface1(py::module_& module) {
    py::class_<InnerInterface1, std::shared_ptr<InnerInterface1>, InnerClassForwardDeclarationsInnerInterface1Trampoline>(module, "InnerClassForwardDeclarationsInnerInterface1")
        ...
        .def(py::init([](std::shared_ptr<InnerInterface1> native) {
            auto self = std::make_shared<InnerClassForwardDeclarationsInnerInterface1Trampoline>();
            self->m_impl = native;
            return self;
        }))
        ;
