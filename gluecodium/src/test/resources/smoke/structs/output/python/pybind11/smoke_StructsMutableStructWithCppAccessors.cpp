...
void register_StructsMutableStructWithCppAccessors(py::module_& module) {
    py::class_<MutableStructWithCppAccessors>(module, "StructsMutableStructWithCppAccessors")
