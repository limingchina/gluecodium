...
void register_StructsImmutableStructWithCppAccessors(py::module_& module) {
    py::class_<ImmutableStructWithCppAccessors>(module, "StructsImmutableStructWithCppAccessors")
