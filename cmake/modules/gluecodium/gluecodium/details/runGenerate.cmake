...
function(_prepare_gluecodium_config_file file_path placeholder_file)
  ...
  _append_option(jspackage GLUECODIUM_JS_PACKAGE)
  _append_option(jsintpackage GLUECODIUM_JS_INTERNAL_PACKAGE)
  _append_option(jsmodule GLUECODIUM_JS_MODULE_NAME)
  _append_boolean_value(jsemittestubs "${GLUECODIUM_JS_EMIT_TYPESCRIPT_STUBS}")
  ...
  _append_path_option(jsnamerules GLUECODIUM_JS_NAMERULES)
...
function(_collect_all_files_in_single_compilation_units)
  ...
  if(js IN_LIST GLUECODIUM_GENERATORS)
    _include_all(js "js/embind/*.cpp")
  endif()
endfunction()
