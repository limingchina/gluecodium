...
def test_comments_class_docstring():
    ...
    assert generated.Comments.__doc__ == "This is some very useful ."
    
def test_comments_function_docstring():
    """Test that function-level comments are preserved as Python docstrings."""
    assert generated.Comments.some_method_with_all_comments.__doc__ == "This is some very useful method that measures the usefulness of its input."
    assert generated.Comments.some_method_with_input_comments.__doc__ == "This is some very useful method that measures the usefulness of its input."
    assert generated.Comments.some_method_with_output_comments.__doc__ == "This is some very useful method that measures the usefulness of its input."
    
def test_comments_no_function_docstring():
    """Test that functions without comments don't emit empty docstrings."""
    assert generated.Comments.some_method_with_nothing.__doc__ == ""
    
def test_comments_property_docstring():
    """Test that property comments are preserved as Python docstrings."""
    assert generated.Comments.is_some_property.__doc__ == "Some very useful property."
    assert generated.Comments.only_getter_property.__doc__ == "OnlyGetterProperty, which does not have a setter."

def test_comments_constant_comment():
    """Test that module-level constant comments are preserved as Python comments."""
    import inspect
    source = inspect.getsource(generated.Comments)
...
def test_comments_interface_docstring():
    ...
    assert generated.CommentsInterface.__doc__ == "This is some very useful interface."

def test_comments_interface_function_docstrings():
    """Test that interface method comments are preserved as Python docstrings."""
    assert generated.CommentsInterface.some_method_with_all_comments.__doc__ == "This is some very useful method that measures the usefulness of its."

def test_comments_interface_property_docstrings():
    """Test that interface property comments are preserved as Python docstrings."""
    assert generated.CommentsInterface.is_some_property.__doc__ == "Some very useful property."
    assert generated.CommentsInterface.is_some_property.setter.__doc__ == "Sets some very useful property."

def test_comments_interface_constant_comment():
    """Test that interface constant comments are preserved as Python comments."""
    import inspect
    source = inspect.getsource(generated.CommentsInterface)
    assert "# This is some very useful constant." in source
    assert "VERY_USEFUL = True" in source

def test_comments_struct_docstring():
    """Test that struct comments are preserved as Python docstrings."""
    assert generated.CommentsInterfaceSomeStruct.__doc__ == "This is some very useful struct."

def test_comments_interface_nested_struct_field_comment():
    """Test that struct field comments are preserved as Sphinx-style comments in stub files."""
    import inspect
    source = inspect.getsource(generated.CommentsInterfaceSomeStruct)
...
def test_comments_interface_enum_docstring():
    ...
    assert generated.CommentsInterfaceSomeEnum.__doc__ == "This is some very useful enum."
...
def test_comments_stub_no_function_docstring():
    ...
    from smoke.Comments import Comments
    assert Comments.some_method_with_nothing.__doc__ == ""

def test_comments_stub_property_docstrings():
    """Test that stub property docstrings are preserved."""
    from smoke.Comments import Comments
    assert Comments.is_some_property.__doc__ == "Some very useful property."
    assert Comments.only_getter_property.__doc__ == "OnlyGetterProperty, which does not have a setter."
    assert Comments.is_some_property.setter.__doc__ == "Sets some very useful property."
...
def test_comments_stub_interface_docstring():
    ...
    from smoke.Comments import CommentsInterface
...
def test_comments_stub_nested_struct_docstring():
    ...
    from smoke.Comments import CommentsInterfaceSomeStruct
    assert CommentsInterfaceSomeStruct.__doc__ == "This is some very useful struct."

def test_comments_stub_nested_struct_field_comment():
    """Test that stub struct field comments are preserved as Sphinx-style comments."""
    import inspect
    from smoke.Comments import CommentsInterfaceSomeStruct
    source = inspect.getsource(CommentsInterfaceSomeStruct)
    assert "#: How useful this struct is" in source