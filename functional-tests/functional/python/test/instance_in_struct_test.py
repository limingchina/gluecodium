...
"""Instance-in-struct (regression test for a struct holding a class instance) tests
for the Python (pybind11) bindings."""
...
class TestInstanceInStruct:
    ...
    def test_copy_instance_in_struct_from_method(self):
        holder = InstanceInStruct.create_in_struct()
        holder.my_self.set_string_value("Hello")
